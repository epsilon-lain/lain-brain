// Experiment 04 prompt instrument.
//
...
import type { Experiment04Fixture as FrozenFixture } from "./Experiment04Definition";

export type Experiment04ConditionId =
  | "plain_llm"
  | "irrelevant_context"
  | "brain_identity_only"
  | "brain_definition"
...
const INTERNAL_CONDITION_IDS: readonly Experiment04ConditionId[] = [
  "plain_llm",
  "irrelevant_context",
  "brain_identity_only",
  "brain_definition",
...
function contextFor(
  fixture: Readonly<Experiment04Fixture>,
  condition: Experiment04ConditionId
): string | undefined {
  switch (condition) {
    case "plain_llm":
      return undefined;
...
export function assertExperiment04PromptHasNoInternalConditionIds(
...
export function buildExperiment04ProviderMessages(
  fixture: Readonly<Experiment04Fixture>,
  condition: Experiment04ConditionId
  ...
  assertExperiment04PromptHasNoInternalConditionIds(messages);
  return messages;
}
...
export function renderExperiment04TreatmentPayload(
...
export function buildFrozenExperiment04ProviderMessages(
  fixture: Readonly<FrozenFixture>,
  condition: Experiment04ConditionId,
